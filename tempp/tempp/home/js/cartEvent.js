    ...
    return `
        <li class="modal__cart-product-item">
            <div class="modal__cart-imgbox">
                <img class="modal__cart-img" src="${product.image}" alt="">
            </div>
        ...
        <div class="cartPage__product">
            <div class="cartPage__product-item">
                <div class="cartPage__product-imgBox">
                    <img class="cartPage__product-img" src="${product.image}" alt="">
                </div>
...
$$('.addToCart').forEach((item) => {
    item.onclick = () => {
        ...
        let product = ProductModel.getAll().filter((product) => product.id == id)[0];
