    ...
    <div class="container">
        ...
        <div class="tmanager tmanager-bill">
            ...
            <div class="table-search">
                ...
                class="input-search"
                type="text"
                placeholder="Search bill by username"
                />
            </div>
            </div>
            <div class="t-wrap">
            ...
            <div class="button-add add-category" style="visibility: hidden;"><i class="fas fa-plus"></i></div>
        ...
        <div class="tmanager tmanager-revenue">
            ...
            <div class="table-search search-category">
                <select name="search-category" id="select-search-category">
                </select>
            </div>
            </div>
            <div class="t-wrap">
